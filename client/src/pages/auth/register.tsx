    ...
    <div className="min-h-screen bg-background flex flex-col">
      <nav className="flex items-center justify-between px-6 py-4 border-b">
        <a href="/" className="flex items-center gap-2">
          ...
          <span className="text-lg font-bold text-foreground">DairyPro</span>
        </a>
        <ThemeToggle />
      </nav>
          ...
          <Card className="border shadow-sm">
            <CardContent className="pt-6 space-y-4">
              ...
              <a
                ...
                className="flex items-center justify-center gap-3 w-full border rounded-lg px-4 py-2.5 text-sm font-medium hover:bg-accent transition-colors"
